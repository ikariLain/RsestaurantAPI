...
namespace RestaurantAPI.DTOs.ServiceOrder
{
    public class ServiceOrderPutDTO
    {
        ...
        [Required(ErrorMessage = "Missing Reservation")]
        public int Reservation_FK { get; set; }

        [Required(ErrorMessage = "Missing total price amount"), 
        Range(0.01, 100000, ErrorMessage = "Total price amount must be between 0.01 and 100000")]
